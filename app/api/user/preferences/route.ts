...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      applicationsStatus: user.applicationsStatus || 'notStarted',
        ...
        $set: {
          ...
          availability: {
            ...
            address: {
              ...
              city: data.availability.address.city,
              state: data.availability.address.state || '',
              zipCode: data.availability.address.zipCode,
              country: data.availability.address.country,
            },
