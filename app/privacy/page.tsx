      ...
      <div className='max-w-3xl mx-auto'>
        ...
        <div className='prose prose-blue max-w-none'>
          ...
          <p>
            ...
            information when you use our service. Please read this privacy policy carefully. If you
          ...
          <ul>
            ...
            <li>To send you job recommendations and updates</li>
            <li>To help you find relevant employment opportunities</li>
          ...
          <ul>
            ...
            <li>With our service providers who assist us in operating our platform</li>
          </ul>
